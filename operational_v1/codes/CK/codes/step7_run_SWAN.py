...
def run_SWAN(now):
    ...
    source_dir ='../extras/rarotonga/swan'
    ...
    out_name_w= os.path.join('..','runs', now.strftime("%Y") + now.strftime("%m") + now.strftime("%d") + now.strftime("%H"),'SWAN')

    command = f'cd {out_name_w} && ..\..\..\models\SWAN\swanrun swanconf'
