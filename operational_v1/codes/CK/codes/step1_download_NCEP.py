...
# function to convert grib2 files to netCDF, it uses the java script "toolsUI-5.4.1.jar" that needs to be placed in the same folder where this script is being called    
    subprocess.call(["C:\Program Files (x86)\Common Files\Oracle\Java\java8path\java.exe", "-Xmx512m", "-cp", "toolsUI-5.4.1.jar", "ucar.nc2.dataset.NetcdfDataset", "-in", grb_fl_name, "-out", nc_fl_name], shell=True,)
