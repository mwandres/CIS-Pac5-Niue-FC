...
def plot_Hs_Dir_maps(nat,tar,dtt,x,y,triang,Time,Hs,Dir,result_folder):
    ...
    f = open('../extras/niue/swan/Hs_colormap.dat', 'r') # 'r' = read
...
def postprocess_SWAN(now,plot):
    ...
    shapefile_path = '../extras/niue/gis/Transect_Niue_100_20241104.shp'
    ...
    #inc = 0.00025# about 10 m 
    inc = 0.1
    print('Saving results to NetCDF file')
    namenc = folder_tmp  + '/Niue.nc'  
